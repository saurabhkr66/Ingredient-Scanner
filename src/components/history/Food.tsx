...
import CountingfoodIngredientChart from "./countfoodingredient";
        ...
        <div className="p-4 pt-20">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3 lg:grid-cols-4">
              <div className="col-span-1 space-y-4 md:col-span-2 lg:col-span-3">
                {[
                  ...
                  { label: "Allergic", value: report.allergens_health_risks },
                ].map((item, idx) => (
          ...
          <div className="mt-8 rounded-xl bg-blue-50 p-4 shadow-sm lg:min-w-[800px] dark:bg-black">
            <div className="mx-40 mt-4 mb-6 flex items-center justify-between">
              <CircleScoreChart score={report.health_score} />
              <CountingfoodIngredientChart report={report} />
            </div>
          </div>

          <div className="pt-8 pb-8">
            <FoodSummary report={report} />
          </div>

          <div className="rounded-xl bg-blue-50 p-6 shadow-sm lg:min-w-[800px] dark:bg-gray-800">
            ...
            <div className="grid grid-cols-1 gap-[60px] md:grid-cols-2 lg:grid-cols-3">
              {report.ingredients.map((ingredient, idx) => {
                const style = statusStyles[ingredient.category] || statusStyles.Neutral;
                return (
                  <div
                    key={idx}
