...
export default function PhotoAccessToast({
  onAllow,
  onChooseAnother,
}: {
  onAllow: () => void;
  ...
  return (
    <div className="flex flex-col items-center space-y-3 p-4 text-center">
      ...
      <h3 className="text-lg font-semibold">Allow Gallary Access</h3>
      <p className="text-sm text-gray-600">
        To scan your product label in real time, we need access to your Photo Library.
        <br />
